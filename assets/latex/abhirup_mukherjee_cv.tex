...
\begin{center}
    ...
    \small
    \faEnvelope\ \href{mailto:abhirup.mukherjee@utdallas.edu}{abhirup.mukherjee@utdallas.edu} \quad
...
\begin{itemize}
    \item \textbf{A. Mukherjee}, L. Khan, and B. Thuraisingham, ``Activation Steering for Smart Contract Vulnerability Detection: A Calibration Mechanism Bounded by Pre-Training Knowledge,'' \textit{IEEE International Conference on Intelligence and Security Informatics (ISI)}, Cambridge, UK, 2026. Oral presentation. \href{https://ieeexplore.ieee.org/document/11685839}{[Link]} \href{https://mukherjeeabhirup.github.io/assets/pdf/activation-steering-isi-2026-accepted-version.pdf}{[Paper]} \href{https://mukherjeeabhirup.github.io/assets/pdf/isi_paper_poster_portrait_CCC.pdf}{[Poster]}
\end{itemize}
\subsection*{Thesis}
\begin{itemize}
